...
flowchart TD
    ...
    Task1 --> Task2[Task 2: Create Virtual
    Network with
    GatewaySubnet]

    Task2 --> Task3[Task 3: Create Public IP<br/>for VPN Gateway]

    Task3 --> Task4[Task 4: Create VPN
    Gateway]

    Task4 --> Task5[Task 5: Create Local
    Network Gateway for
    On-Prem]

    Task5 --> Task6[Task 6: Create VPN
    Connection IPsec S2S]

    Task6 --> Task7[Task 7: Wait for VPN
    Gateway Public IP
    Assignment]
    ...
    Task9 --> PASection["Palo Alto Firewall
    Configuration"]
